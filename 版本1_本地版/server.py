...
async def websocket(request):
    ...
    try:
        ...
        now = time.monotonic()
        await ws.send_json({"type": "welcome", "protocol": 9, "edition": "local", "network_rate": NETWORK_RATE,
...
async def health(_):
    return web.json_response({"game": "neon-brawl", "edition": "local", "status": "ok", "protocol": 9})
